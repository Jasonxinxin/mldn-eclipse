...
<%
	String DEPT_ADD_URL = request.getAttribute("basePath") + "pages/back/admin/dept/dept_add.action" ;
%>
					...
					<form class="form-horizontal" action="<%=DEPT_ADD_URL%>" id="myform" method="post">
						<fieldset>
							...
							<div class="form-group" id="dnameDiv">
								...
								<div class="col-md-5">
									<!-- 定义表单输入组件 -->
									<input type="text" id="dname" value="测试部" name="dname" class="form-control"
							...
							<div class="form-group" id="maxnumDiv">
								...
								<div class="col-md-5">
									<!-- 定义表单输入组件 -->
									<input type="text" id="maxnum" value="10" name="maxnum" class="form-control"
							...
							<div class="form-group" id="noteDiv">
								...
								<div class="col-md-5">
									...
									<textarea id="note" name="note"
										class="form-control" placeholder="请输入该部门的主要职能" rows="10">测试一哈，拜拜</textarea>
								</div>
								<!-- 定义表单错误提示显示元素 -->
